...
namespace Command_Design_Pattern.Commands
{
    public class PdfFile<T>
    {
        ...
        public MemoryStream Create()
        {
            ...
            _list.ForEach(x =>
            {
                var values = type.GetProperties().Select(propInfo => propInfo.GetValue(x, null)).ToList();
                sb.Append("<tr>");
                ...
                Objects = { new ObjectSettings()
                  {
                    ...
                    WebSettings = { DefaultEncoding = "utf-8" ,UserStyleSheet=Path.Combine(Directory.GetCurrentDirectory(),"wwwroot/lib/bootstrap/dist/css/bootstarp.css")},
